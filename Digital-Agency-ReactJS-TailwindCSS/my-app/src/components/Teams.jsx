...
const Teams = () => {
    return (
        <>
            <div id="meet-the-team" className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>

                <Title title='Meet the team' desc='A passionate team of professionals and digital experts' />
